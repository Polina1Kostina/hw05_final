...
Данный веб-сервис поддерживает авторизацию и безопасную аутентификацию пользователей, а также размещение постов, которые можно разделять по группам и комментировать. У каждого пользователя есть возможность подписаться на любимых авторов и следить за их новостями. 
## Технологии
